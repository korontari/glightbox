...
Glightbox is a javascript lightbox plugin. This module provides a field
formatter that allows a site visitor to click on an image and view that image
in a responsive lightbox modal. 

If there are multiple images then the modal can be configured to show
all the images in a slideshow format (see Gallery setting).
...
Global configuration options can be found at: admin/config/media/glightbox
